# Documentation Sync Pack | 文档同步包: Design system refresh 设计令牌体系升级

- Sync ID | 同步 ID: `design-system-refresh-设计令牌体系升级`
- Generated | 生成时间: `2026-03-20T17:48:02+00:00`
- README Strategy | README 策略: `full-rewrite`

## Change Summary | 变更摘要

Added design token system guidance, starter pack generation, automatic visual read-order, and README updates.

## Changed Files | 变更文件

- `src/aidrp/design_token_pack.py`
- `src/aidrp/task_packet.py`
- `docs/playbooks/design-token-system-设计令牌体系.md`
- `README.md`

## Change Notes | 变更备注

- UI workflow now requires a design-token pass before component generation.
